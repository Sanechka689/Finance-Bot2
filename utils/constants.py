...
STATE_IDLE               = 0  # нет активного диалога
STATE_OP_FIELD_CHOOSE    = 1  # выбираем поле (Дата, Банк, …)
STATE_OP_FIELD_INPUT     = 2  # вводим значение для выбранного поля
STATE_OP_MENU            = 3  # 4.1: показ кнопок “Добавить” / “Меню”