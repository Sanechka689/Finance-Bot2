...
# Этап 4: Статусы для ручного ввода операций
STATE_IDLE               = 0  # 1.1.1: нет активного процесса
STATE_OP_FIELD_CHOOSE    = 1  # 1.1.2: пользователь выбирает, какое поле заполнить
STATE_OP_FIELD_INPUT     = 2  # 1.1.3: пользователь вводит значение выбранного поля