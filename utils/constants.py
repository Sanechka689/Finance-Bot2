...
# Этап 6 — раздел «Планы»
STATE_PLAN_MENU           = 30  # главное меню «Планы»
STATE_PLAN_ADD            = 31  # начало создания новой карточки плана
STATE_PLAN_DATE           = 32  # ввод/выбор даты для плана
STATE_PLAN_AMOUNT         = 33  # ввод суммы плана
STATE_PLAN_CLASSIFICATION = 34  # ввод поля «Классификация»
STATE_PLAN_SPECIFIC       = 35  # ввод поля «Конкретика»
STATE_PLAN_CONFIRM        = 36  # подтверждение записи плана
STATE_PLAN_COPY           = 37  # перенос прошлых планов на текущий месяц
